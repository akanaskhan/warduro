          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mb-4">
              ...
              <a className="" href="https://www.facebook.com/warduro-61560668013222" target="_blank">
                ...
                <a className="text-gray-500 " href="https://api.whatsapp.com/send/?phone=923370791676" target="_blank" >
                <i
                      className="fa-brands fa-whatsapp  text-gray-500 text-xl mx-2 "
                   
                    />
                </a>
                <a className="text-gray-500" href="https://www.instagram.com/warduro_official" target="_blank">
